...
For the underlying tooling, see [Software](../software).
...
In China, I have given research talks and led a round table on the role of large-scale data infrastructure in genomics — that work is conversational rather than instructional, and is listed under [Conferences](../outreach/conferences) and [Invited Talks](../outreach/invited).
...
For full course details, see [Teaching](../teaching).
...
For commercial and government engagements where cloud-based genomic analysis has been a core deliverable, see [Advisory and Consulting](../consulting).
